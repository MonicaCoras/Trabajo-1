...
texto = """
Hola! Soy Mónica Coras, estudiante de publicidad de 5to ciclo, aquí te cuento sobre mi experiencia llevando el curso de Pensamiento Computacional que agregaron luego del cambio de malla curricular
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Aquí estan algunos de los gráficos que hice con Matpolib</h1>", unsafe_allow_html=True)
...
if grafico_seleccionado == 'pastel':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>En este gráfico circular se presenta el promedio de goles de un equipo de fútbol usando una base de datos.</div>", unsafe_allow_html=True)
    sidebar.image("pastel.png", caption='pastel', width=500)
    pass
elif grafico_seleccionado == 'barras':
    sidebar.markdown("<div style='text-align: justify'>En este gráfico de barras se realiza una comparación de datos.</div>", unsafe_allow_html=True)
    sidebar.image("barras.png", caption='barras', width=500)
    pass
elif grafico_seleccionado == 'mapa':
    sidebar.markdown("<div style='text-align: justify'>Este es un mapa creado con Geopandas en el que se indican las distintas ciudades en las que se grabaron algunas de mis películas favoritas.</div>", unsafe_allow_html=True)
    sidebar.image("mapa.png", caption='Mapa', width=500)
    pass

# if grafico_seleccionado == 'Gráfico de Macroareas':: Esta línea verifica si la opción seleccionada es 'pastel'.
...
# La palabra clave pass se utiliza para indicar que no se debe hacer nada en caso de que la opción seleccionada no sea 'pastel'.